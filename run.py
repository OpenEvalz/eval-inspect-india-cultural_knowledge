#!/usr/bin/env python3
"""Run ONE problem of inspect-india-cultural_knowledge through TrustedRouter and emit a reproducibility bundle.
...
TASK = "inspect_evals/cultural_knowledge"
...
def main() -> int:
    ap = argparse.ArgumentParser(description="Run one inspect-india-cultural_knowledge problem via TrustedRouter")
