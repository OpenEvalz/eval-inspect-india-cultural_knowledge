...
`eval-inspect-india-cultural_knowledge` packages an evaluation from **inspect_evals**.

- **Upstream:** https://github.com/UKGovernmentBEIS/inspect_evals (`register/inspect-india-cultural_knowledge`)
