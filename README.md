# eval-inspect-india-cultural_knowledge
...
Evaluates LLM knowledge of Indian culture, history, and context, part of the Inspect India
...
| | |
|---|---|
| Upstream | [`register/inspect-india-cultural_knowledge`](https://github.com/UKGovernmentBEIS/inspect_evals/tree/main/register/inspect-india-cultural_knowledge) |
| Group | — |
| Total samples | 0 |
...
```bash
inspect eval inspect_evals/cultural_knowledge \
  --sample-id "<sample-id>" \
